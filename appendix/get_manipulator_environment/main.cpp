...
void status_changed_callback() noexcept {
  switch (libkrbn_core_service_daemon_client_get_status()) {
    case libkrbn_core_service_daemon_client_status_connected:
    ...
    case libkrbn_core_service_daemon_client_status_connect_failed:
      std::cerr << "core_service_daemon_client connect_failed" << std::endl;
      break;

    case libkrbn_core_service_daemon_client_status_closed:
      std::cerr << "core_service_daemon_client closed" << std::endl;
      break;

    case libkrbn_core_service_daemon_client_status_none:
      break;
  }
}

void manipulator_environment_received_callback(const char* json_string) noexcept {
...
int main() {
  ...
  libkrbn_register_core_service_daemon_client_status_changed_callback(status_changed_callback);
  libkrbn_register_core_service_daemon_client_manipulator_environment_received_callback(manipulator_environment_received_callback);
