...
int main(int argc, const char* argv[]) {
  ...
  krbn::manipulator::manipulator_timer::get_instance().timer_invoked.connect([&](auto timer_id) {
    krbn::logger::get_logger().info("timer_id {0}", static_cast<uint64_t>(timer_id));
