...
TEST_CASE("manipulator.pointing_button_manager") {
  krbn::manipulator::pointing_button_manager pointing_button_manager;

  krbn::manipulator::pointing_button_manager::active_pointing_button button1_1(krbn::manipulator::pointing_button_manager::active_pointing_button::type::increase,
                                                                               krbn::pointing_button::button1,
                                                                               krbn::device_id(1));

  krbn::manipulator::pointing_button_manager::active_pointing_button button2_1(krbn::manipulator::pointing_button_manager::active_pointing_button::type::increase,
                                                                               krbn::pointing_button::button2,
                                                                               krbn::device_id(1));

  krbn::manipulator::pointing_button_manager::active_pointing_button button3_1(krbn::manipulator::pointing_button_manager::active_pointing_button::type::increase,
                                                                               krbn::pointing_button::button3,
                                                                               krbn::device_id(1));

  krbn::manipulator::pointing_button_manager::active_pointing_button button20_1(krbn::manipulator::pointing_button_manager::active_pointing_button::type::increase,
