...
TEST_CASE("is_repeating") {
  ...
  keyboard_repeat_detector.set(*(krbn::make_hid_usage_page(krbn::key_code::spacebar)),
  ...
  keyboard_repeat_detector.set(*(krbn::make_hid_usage_page(krbn::key_code::left_shift)),
                               *(krbn::make_hid_usage(krbn::key_code::left_shift)),
                               krbn::event_type::key_down);
  REQUIRE(keyboard_repeat_detector.is_repeating() == true);
  ...
  keyboard_repeat_detector.set(*(krbn::make_hid_usage_page(krbn::key_code::escape)),
                               *(krbn::make_hid_usage(krbn::key_code::escape)),
                               krbn::event_type::key_down);
  REQUIRE(keyboard_repeat_detector.is_repeating() == true);
