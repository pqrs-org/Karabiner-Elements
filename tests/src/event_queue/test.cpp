...
TEST_CASE("push_back_event") {
  // normal order
  {
    ...
    event_queue.push_back_event(krbn::event_queue::scope::input,
    ...
    REQUIRE(event_queue.get_input_events() == std::vector<krbn::event_queue::queued_event>({
                                                  krbn::event_queue::queued_event(krbn::event_queue::scope::input,
                                                                                  std::chrono::nanoseconds(100),
                                                                                  *(krbn::types::get_key_code("a")),
                                                                                  krbn::event_type::key_down),
                                                  krbn::event_queue::queued_event(krbn::event_queue::scope::input,
