...
TEST_CASE("simple_modifications.to_json") {
  ...
  }
  {
    ...
    krbn::core_configuration::details::simple_modifications simple_modifications(json);
    {
      krbn::manipulator::manipulators::basic::basic::from_event_definition from_event_definition(nlohmann::json::parse(simple_modifications.get_pairs()[0].first));
    ...
    {
      krbn::manipulator::manipulators::basic::basic::from_event_definition from_event_definition(nlohmann::json::parse(simple_modifications.get_pairs()[1].first));
      REQUIRE(from_event_definition.get_event_definitions().size() == 1);
