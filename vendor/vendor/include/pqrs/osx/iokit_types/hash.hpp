...
namespace std {
template <>
struct hash<std::tuple<pqrs::hid::vendor_id::value_t,
                       pqrs::hid::product_id::value_t,
                       pqrs::osx::iokit_hid_location_id::value_t>> {
  [[nodiscard]] size_t operator()(const std::tuple<pqrs::hid::vendor_id::value_t,
                                                   pqrs::hid::product_id::value_t,
                                                   pqrs::osx::iokit_hid_location_id::value_t>& tuple) const noexcept {
    size_t h = 0;
