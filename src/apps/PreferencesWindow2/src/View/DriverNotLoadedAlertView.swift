                    ...
                    GroupBox {
                        VStack(alignment: .center, spacing: 20.0) {
                            VStack(alignment: .center, spacing: 0) {
                                ...
                                Text("Please allow \".Karabiner-VirtualHIDDevice-Manager\" on Security & Privacy System Preferences.")
                            }
                            ...
                            Button(action: { showingAdvanced = true }) {
                                Label("If the Allow button is not displayed on Security & Privacy.",
...
struct DriverNotLoadedAlertView_Previews: PreviewProvider {
    static var previews: some View {
        Group {
            DriverNotLoadedAlertView(parentWindow: nil,
