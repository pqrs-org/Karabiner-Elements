...
bool libkrbn_services_daemons_enabled(void);
bool libkrbn_services_agents_enabled(void);
...
typedef enum {
  libkrbn_core_service_daemon_client_status_none,
  libkrbn_core_service_daemon_client_status_connected,
  libkrbn_core_service_daemon_client_status_connect_failed,
  libkrbn_core_service_daemon_client_status_closed,
} libkrbn_core_service_daemon_client_status;

void libkrbn_enable_core_service_daemon_client(void);
void libkrbn_disable_core_service_daemon_client(void);

void libkrbn_core_service_daemon_client_async_start(void);

typedef void (*libkrbn_core_service_daemon_client_status_changed_t)(void);
void libkrbn_register_core_service_daemon_client_status_changed_callback(libkrbn_core_service_daemon_client_status_changed_t _Nonnull callback);
void libkrbn_unregister_core_service_daemon_client_status_changed_callback(libkrbn_core_service_daemon_client_status_changed_t _Nonnull callback);

libkrbn_core_service_daemon_client_status libkrbn_core_service_daemon_client_get_status(void);

void libkrbn_core_service_daemon_client_async_temporarily_ignore_all_devices(bool value);

void libkrbn_core_service_daemon_client_async_get_manipulator_environment(void);
typedef void (*libkrbn_core_service_daemon_client_manipulator_environment_received_t)(const char* _Nonnull json_string);
void libkrbn_register_core_service_daemon_client_manipulator_environment_received_callback(libkrbn_core_service_daemon_client_manipulator_environment_received_t _Nonnull callback);
void libkrbn_unregister_core_service_daemon_client_manipulator_environment_received_callback(libkrbn_core_service_daemon_client_manipulator_environment_received_t _Nonnull callback);

void libkrbn_core_service_daemon_client_async_get_connected_devices(void);
typedef void (*libkrbn_core_service_daemon_client_connected_devices_received_t)(const char* _Nonnull json_string);
...
void libkrbn_core_service_daemon_client_async_get_notification_message(void);
typedef void (*libkrbn_core_service_daemon_client_notification_message_received_t)(const char* _Nonnull message);
...
void libkrbn_core_service_daemon_client_async_get_system_variables(void);
typedef void (*libkrbn_core_service_daemon_client_system_variables_received_t)(const char* _Nonnull json_string);
...
void libkrbn_core_service_daemon_client_async_connect_multitouch_extension(void);
...
void libkrbn_console_user_server_client_async_get_settings_window_guidance(void);
typedef void (*libkrbn_console_user_server_client_settings_window_guidance_received_t)(const char* _Nonnull json_string);
void libkrbn_register_console_user_server_client_settings_window_guidance_received_callback(libkrbn_console_user_server_client_settings_window_guidance_received_t _Nonnull callback);
void libkrbn_unregister_console_user_server_client_settings_window_guidance_received_callback(libkrbn_console_user_server_client_settings_window_guidance_received_t _Nonnull callback);
