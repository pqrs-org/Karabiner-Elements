...
//
// On macOS, even after Karabiner-Core-Service has seized a device, the original hardware key press status is retained.
// Once the device is seized, Karabiner-Core-Service emits events from a virtual HID keyboard,
