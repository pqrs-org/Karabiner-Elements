...
public:
  static boost::optional<std::pair<event_type, event_queue::queued_event::event>> make_event(CGEventType type,
                                                                                             CGEventRef event) {
    switch (type) {
      case kCGEventLeftMouseDown:
        return std::make_pair(event_type::key_down,
                              event_queue::queued_event::event(pointing_button::button1));
      ...
      case kCGEventRightMouseDown:
        return std::make_pair(event_type::key_down,
                              event_queue::queued_event::event(pointing_button::button2));
      ...
      case kCGEventOtherMouseDown:
        return std::make_pair(event_type::key_down,
                              event_queue::queued_event::event(pointing_button::button3));
      ...
      case kCGEventOtherMouseDragged:
        return std::make_pair(event_type::single,
                              event_queue::queued_event::event(pointing_motion()));
