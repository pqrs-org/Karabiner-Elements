...
public:
  ...
  public:
    ...
    parameters(const nlohmann::json& json) : json_(json),
                                             ...
                                             basic_to_if_doublepress_timeout_milliseconds_(500){
      update(json);
    }
    ...
    int get_basic_to_if_doublepress_timeout_milliseconds(void) const {
      return basic_to_if_doublepress_timeout_milliseconds_;
    }
  ...
  private:
    std::unordered_map<std::string, const int&> make_map(void) const {
      return {
          ...
          {"basic.to_if_doublepress_timeout_milliseconds", basic_to_if_doublepress_timeout_milliseconds_},
      };
    }

    nlohmann::json json_;
      int basic_to_if_alone_timeout_milliseconds_;
      int basic_to_if_doublepress_timeout_milliseconds_;
  };
