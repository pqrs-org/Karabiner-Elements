...
namespace impl {
constexpr std::pair<const mapbox::eternal::string, const key_code> key_code_name_value_pairs[] = {
    // Aliases
...
constexpr auto key_code_name_value_map = mapbox::eternal::hash_map<mapbox::eternal::string, key_code>(key_code_name_value_pairs);
} // namespace impl

inline std::string make_key_code_name(key_code key_code) {
  for (const auto& pair : impl::key_code_name_value_pairs) {
...
inline std::optional<key_code> make_key_code(const std::string& name) {
  auto& map = impl::key_code_name_value_map;
...
inline std::optional<key_code> make_key_code(pqrs::hid::usage_page::value_t usage_page,
...
inline std::optional<pqrs::hid::usage_page::value_t> make_hid_usage_page(key_code key_code) {
  switch (key_code) {
    case key_code::fn:
...
inline std::optional<pqrs::hid::usage::value_t> make_hid_usage(key_code key_code) {
  switch (key_code) {
      //
      // pqrs::hid::usage_apple_vendor_top_case_*
      //

    case key_code::fn:
      return pqrs::hid::usage::apple_vendor_top_case::keyboard_fn;

    case key_code::illumination_decrement:
      return pqrs::hid::usage::apple_vendor_top_case::illumination_down;

    case key_code::illumination_increment:
      return pqrs::hid::usage::apple_vendor_top_case::illumination_up;

    case key_code::apple_top_case_display_brightness_decrement:
      return pqrs::hid::usage::apple_vendor_top_case::brightness_down;

    case key_code::apple_top_case_display_brightness_increment:
      return pqrs::hid::usage::apple_vendor_top_case::brightness_up;
    ...
    case key_code::dashboard:
      return pqrs::hid::usage::apple_vendor_keyboard::dashboard;

    case key_code::launchpad:
      return pqrs::hid::usage::apple_vendor_keyboard::launchpad;

    case key_code::mission_control:
      return pqrs::hid::usage::apple_vendor_keyboard::expose_all;

    case key_code::apple_display_brightness_decrement:
      return pqrs::hid::usage::apple_vendor_keyboard::brightness_down;

    case key_code::apple_display_brightness_increment:
      return pqrs::hid::usage::apple_vendor_keyboard::brightness_up;
    ...
    case key_code::mute:
      return pqrs::hid::usage::consumer::mute;

    case key_code::volume_decrement:
      return pqrs::hid::usage::consumer::volume_decrement;

    case key_code::volume_increment:
      return pqrs::hid::usage::consumer::volume_increment;

    case key_code::display_brightness_decrement:
      return pqrs::hid::usage::consumer::display_brightness_decrement;

    case key_code::display_brightness_increment:
      return pqrs::hid::usage::consumer::display_brightness_increment;

    case key_code::rewind:
      return pqrs::hid::usage::consumer::rewind;

    case key_code::play_or_pause:
      return pqrs::hid::usage::consumer::play_or_pause;

    case key_code::fastforward:
      return pqrs::hid::usage::consumer::fast_forward;

    case key_code::eject:
      return pqrs::hid::usage::consumer::eject;

    case key_code::vk_none:
      return std::nullopt;

    default:
      return pqrs::hid::usage::value_t(static_cast<uint32_t>(key_code));
  }
}
